...
function EditModal({ player, onClose, onSaved }) {
    ...
    const handleSave = async () => {
        ...
        try {
            ...
            setSuccess(true);
            // Delay close slightly so user sees the success state
        ...
        >
            <div style={{
                ...
                <div style={{
                    ...
                    <div>
                        <p style={{ margin: 0, fontWeight: '800', fontSize: '15px', color: '#0f172a' }}>
                            Edit Player
                        </p>
                ...
                <div style={{
                    ...
                    <button
                        ...
                        style={{
                            ...
                            fontWeight: '600', cursor: 'pointer', fontSize: '13px', color: '#374151',
                        }}
                    >
                        Cancel
                    </button>
    ...
    return (
        <div style={{
            ...
            <div style={S.playerFooter}>
                ...
                {/* ✅ Fixed: onEdit passed as prop — no broken navigate reference */}
                <button
...
export default function MissingPlayersPage() {
    ...
    // ✅ Real-time: mutate the local list in-place instead of re-fetching.
    // The card updates immediately after save — no full reload needed.
...
const S = {
    ...
    pageIcon:        { width: '44px', height: '44px', borderRadius: '12px', background: '#fff1f2', border: '1px solid #fecaca', display: 'flex', alignItems: 'center', justifyContent: 'center' },
    ...
    statsGrid:       { display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(150px, 1fr))', gap: '12px', marginBottom: '24px' },
    ...
    playerCard:      { borderRadius: '14px', padding: '14px', position: 'relative', overflow: 'hidden' },
    ...
    playerHeader:    { display: 'flex', alignItems: 'center', gap: '10px', marginBottom: '8px' },
    ...
    playerFooter:    { display: 'flex', justifyContent: 'space-between', alignItems: 'center', paddingTop: '8px', borderTop: '1px solid #f1f5f9' },
